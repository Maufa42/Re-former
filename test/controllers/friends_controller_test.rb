...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { email: @friend.email, password: @friend.password, user_name: @friend.user_name } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { email: @friend.email, password: @friend.password, user_name: @friend.user_name } }
